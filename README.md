...
* Password Policy: [LastPass](https://www.lastpass.com/)
...
* Webserver: [Apache](https://httpd.apache.org/), [HCL Domino](https://www.hcl-software.com/domino)
* Smart Home Innovation: [Home Assistant (HA)](https://www.home-assistant.io) 
